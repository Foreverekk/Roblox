...
Global:AddButton({ text = "FPS / Optimize", flag = "buttonFPS", callback = function() 
    loadstring(game:HttpGet(mainRaw.."Scripts/FPS.lua"))()
end })
Global:AddButton({ text = "RTX on", flag = "buttonRTX", callback = function() 
    loadstring(game:HttpGet(mainRaw.."Scripts/RTX.lua"))()
end })
Global:AddButton({ text = "Synapse X", flag = "buttonSynapse", callback = function() 
